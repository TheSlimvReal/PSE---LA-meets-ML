...
Goal was the delivery of a consistent software stack that allows for employing 
...
Instead we decided to handle it directly out of the hdf5 file or from the ssget data.
...
As we figured out our design we realized that generating random matrices
...
In future it would be better to use for example share latex and start a new line for each sentence to minimize git problems.
